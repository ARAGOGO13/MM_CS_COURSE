...
int find_last_element(double, const char*);

int find_last_element(double el, const char *file_name)
{
	double x;
	int read_count = 0;
	int res = 0;
...
int main(int argc, char* argv[]) 
{
	...
	res = find_last_element(el, file_name);
	if (res >= 0) 
		{ 
